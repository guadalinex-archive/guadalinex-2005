...
$Config::IniFiles::VERSION = (qw($Revision: 1.1 $))[1];
require 5.004;
use strict;
use Carp;
...
#	$Header: /cvs/eagleusb/eagleusb/utils/eagleconfig.pl/contrib/Config/IniFiles.pm,v 1.1 2004/02/15 13:00:13 Tux Exp $
...
=head1 Change log
     ...
     $Log: IniFiles.pm,v $
     Revision 1.1  2004/02/15 13:00:13  Tux
     Initial revision

     Revision 1.1.1.1  2003/08/28 13:10:25  jerome
     Initial version of eagleconfig.
